...
function middleware(request) {
    console.log('AUTH_USERNAME:', ("TURBOPACK compile-time value", "rakow"));
    console.log('AUTH_PASSWORD:', ("TURBOPACK compile-time value", "napakowaniRakow"));
    ...
    if (basicAuth) {
        ...
        if (user === ("TURBOPACK compile-time value", "rakow") && pwd === ("TURBOPACK compile-time value", "napakowaniRakow")) {
